...
# IMPORTANT: We must import script_run_context to define force_rerun()
...
def force_rerun():
    """Custom function to force a rerun without using st.experimental_rerun()."""
...
# 2) AUTO-FETCH CONTENT WITH questions < 6 (if none in session)
...
if content_data:
    ...
    if st.button("Save Question"):
        if new_question.strip():
            ...
            # Re-check how many questions exist now
